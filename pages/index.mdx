...
- A diamond is implemented as a fallback function it uses `delegatecall` to route external function calls to facets.

<aside>
💡 *Diamond pattern divides functionality and storage into separate contracts.*
